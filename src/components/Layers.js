...
class Layers extends Component {
    ...
    goAddLayer = (e) => {
        e.preventDefault();
        console.log("click add layer", this.state.path);
        const newLayer = {
                    ...
                    <div>{
                        ...
                        this.props.layers.map(layer => (
                            ...
                            <div key={layer.key} className="alert alert-success" >
                                ...
                                <Button className={layer.edit ? "btn-sm btn-success" : "btn-sm btn-warning"} id={layer.key} onClick={this.setEdit}>
                                ...
                                <Button className="btn-sm btn-danger" id={layer.key} onClick={this.deleteLayer}>
...
export default connect(mapStateToProps, { addLayer })(Layers);